...
const Login = () => {
    ...
    // Use useEffect for conditional navigation
    // useEffect(() => {
    //     if (session) {
    ...
    return (
        <div className='text-white container mx-auto'>
            <h1 className='font-bold text-3xl py-14 text-center'>Login to Get Started</h1>

            <div className="social-login-buttons">
                <div className="flex flex-col gap-2 min-h-screen items-center p-10">

                    <button
                        className="flex items-center w-64 text-white bg-slate-800 border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
